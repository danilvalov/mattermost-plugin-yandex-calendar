module github.com/danilvalov/mattermost-plugin-yandex-calendar
...
// Submodules: github.com/emersion/go-webdav @ v0.7.0 + patches/go-webdav-v0.7.0-yandex-getetag.patch (see make submodules).
