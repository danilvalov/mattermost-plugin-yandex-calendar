...
// Source: github.com/danilvalov/mattermost-plugin-yandex-calendar/calendar/remote (interfaces: Client)
...
func (m *MockClient) PollNotifications(arg0, arg1 string) ([]*remote.Notification, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PollNotifications", arg0, arg1)
	ret0, _ := ret[0].([]*remote.Notification)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// PollNotifications indicates an expected call of PollNotifications.
func (mr *MockClientMockRecorder) PollNotifications(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
